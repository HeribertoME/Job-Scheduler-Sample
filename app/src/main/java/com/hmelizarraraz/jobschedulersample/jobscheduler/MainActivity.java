package com.hmelizarraraz.jobschedulersample.jobscheduler;
...
import com.hmelizarraraz.jobschedulersample.BuildConfig;
import com.hmelizarraraz.jobschedulersample.R;
import com.hmelizarraraz.jobschedulersample.jobscheduler.service.MyJobService;
...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText durationTimeEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new IncomingMessageHandler(this);
    }
    ...
    public void scheduleJob(View v) {
        ...
        boolean requiresAnyConnection = anyConnectivityRadioButton.isChecked();
        if (requiresUnmetered) {
            builder.setRequiredNetworkType(JobInfo.NETWORK_TYPE_UNMETERED);
        } else if (requiresAnyConnection) {
        ...
        String workDuration = durationTimeEditText.getText().toString();
    ...
    /**
     * Executed whe user clicks on FINISH LAST TASK
     * @param v
     */
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public void finishJob(View v) {
        ...
        if (allPendingJobs.size() > 0) {
            ...
            Toast.makeText(
                    MainActivity.this,
                    getString(R.string.no_jobs_to_cancel),
                    Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private static class IncomingMessageHandler extends Handler {
        ...
        // Prevent possible leaks with weak reference
        ...
        private void updateParamsTextView(@Nullable Object jobId, String action) {
            TextView paramsTextView = (TextView) activity.get().findViewById(R.id.task_params);
            if (jobId == null) {
        ...
        private int getColor(@ColorRes int color) {
            return activity.get().getResources().getColor(color);
        }
    }
}
